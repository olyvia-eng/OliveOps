...
export function resolveBeforeClockInForms({ forms = [], fields = [], submissions = [], employee, crews = [], divisions = [], jobs = [], equipment = [], customers = [], service, serviceVisit, instant = new Date(), timeZone }) {
