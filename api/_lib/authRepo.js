...
function normalizeEmployeeForWrite(employee) {
  ...
  return {
    ...
    schedulingColor: typeof employee.schedulingColor === 'string' && employee.schedulingColor.trim() ? employee.schedulingColor.trim().toLowerCase() : undefined,
...
export async function getFileForBusiness(businessId, fileId) {
  ...
  return {
    ...
    checksumSha256: result.Item.checksumSha256,
      pdfValidatedAt: result.Item.pdfValidatedAt,
...
export async function listFormsForBusiness(businessId) {
  ...
  return (result.Items ?? []).map((item) => ({
    ...
    deliveryRuleVersion: item.deliveryRuleVersion,
...
export async function getFormForBusiness(businessId, formId) {
  ...
  return result.Item
    ? {
        ...
        deliveryRule: result.Item.deliveryRule,
        deliveryRuleVersion: result.Item.deliveryRuleVersion,
...
export async function listFormSubmissionsForBusiness(businessId, { consistentRead = false } = {}) {
  ...
  return (result.Items ?? []).map((item) => ({
    ...
    deliveryOccurrenceId: item.deliveryOccurrenceId,
...
export async function getFormSubmissionForBusiness(businessId, formSubmissionId) {
  ...
  return result.Item
    ? {
        ...
        deliveryOccurrenceId: result.Item.deliveryOccurrenceId,
...
export async function listEmployeesForBusiness(businessId) {
  ...
  return (result.Items ?? []).map((item) => ({
    ...
    schedulingColor: item.schedulingColor,
    hourlyRate: item.hourlyRate,
...
export async function getEmployeeForBusiness(businessId, employeeId) {
  ...
  return result.Item
    ? {
        ...
        schedulingColor: result.Item.schedulingColor,
        hourlyRate: result.Item.hourlyRate,
...
export async function createEmployeeWithAccessForBusiness({ businessId, payload }) {
  ...
  const employeeDraft = normalizeEmployeeForWrite({
    ...
    schedulingColor: employeeInput.schedulingColor,
