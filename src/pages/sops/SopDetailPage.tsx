...
function ContentSection({ title, content, fallback }: { title: string; content: string; fallback: string }) {
  return <section><h2 className="font-semibold text-gray-900">{title}</h2><p className="mt-2 whitespace-pre-wrap text-sm leading-6 text-gray-700">{content || fallback}</p></section>;
}
