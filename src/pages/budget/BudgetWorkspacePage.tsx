...
import { ArrowLeft, Archive, BarChart3, Building2, Pencil, Plus, RotateCcw } from 'lucide-react';
...
import CompanyOverheadSection from '../../components/budget/CompanyOverheadSection';
...
export default function BudgetWorkspacePage({ currentUserRole }: Props) {
  ...
  return (
    <div>
      ...
      {activeTab === 'company-overhead' ? <CompanyOverheadSection budget={budget} items={companyOverheadItems} total={financials.companyOverhead} canEdit={canEdit} /> : null}
