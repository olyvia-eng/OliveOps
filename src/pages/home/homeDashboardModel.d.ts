import type { Customer, Crew, Employee, ExternalCalendarEvent, Job, Task, TimeCorrectionRequest, TimeEntry } from '../../types';
...
export function filterTasksByRange(tasks: Task[], filter: HomeTaskFilter, now?: Date): Task[];
