...
export default function EmployeeProfilePage({ currentUserRole }: EmployeeProfilePageProps) {
  ...
  return (
    <div className="space-y-5">
      ...
      {activeTab === 'time-off' ? <Card className="p-6"><EmptyState title="No time-off requests yet" description="OliveOps does not currently have a time-off request model. Requests and approval history will appear here when Time Off is enabled." /></Card> : null}
