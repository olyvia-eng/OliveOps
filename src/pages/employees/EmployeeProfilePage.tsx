...
export default function EmployeeProfilePage({ currentUserRole }: EmployeeProfilePageProps) {
  ...
  const selectedTimeEntry = employeeEntries.find((entry) => entry.id === selectedTimeEntryId) ?? null;
  ...
  return (
    <div className="space-y-5">
      ...
      {activeTab === 'training' ? <EmployeeTrainingSection employeeId={employee.id} /> : null}
      ...
      <TimeEntryDetailModal entry={selectedTimeEntry} employeeName={employee.name} currentUserRole={currentUserRole} onClose={() => setSelectedTimeEntryId(null)} />
