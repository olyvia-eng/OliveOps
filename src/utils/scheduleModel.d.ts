import type { Budget, CalendarColourBy, CalendarPreferences, Crew, Division, GoogleCalendarEvent, Job } from '../types';
...
export function resolveScheduleColour(input: { source?: 'oliveops' | 'google'; colourBy: CalendarColourBy; job?: { status: string }; crew?: Crew | null; division?: Division | null }): ScheduleColour;
