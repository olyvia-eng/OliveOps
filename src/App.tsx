...
import type { Budget, BudgetDivision, BudgetDivisionPlanningItem, BudgetGroup, BudgetItem, BudgetRate, Crew, Customer, Division, Employee, EquipmentAsset, EquipmentBudgetAllocation, Estimate, EstimateTemplate, Expense, FormField, FormRecord, FormResponse, FormSubmission, Invoice, Job, JobTaskHeading, LabourBudgetPlan, LabourClass, LabourHoursSalesGoal, MaterialCatalogItem, RevenueSalesGoal, SubcontractorCatalogItem, Task, TimeCorrectionRequest, TimeEntry, UnbillableTimeCategory } from './types';
...
function clearBusinessDataStore() {
  useStore.setState({
    ...
    materialCatalogItems: [], subcontractorCatalogItems: [], labourClasses: [], invoices: [], templates: [], jobs: [], employees: [], tasks: [], jobTaskHeadings: [], timeEntries: [],
  ...
  const loadBusinessData = async (user: SessionUser | null = sessionUser) => {
    ...
    try {
      ...
      useStore.setState((state) => ({
        ...
        subcontractorCatalogItems: payload.subcontractorCatalogItems ?? [],
